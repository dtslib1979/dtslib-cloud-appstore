...
| **Level 2** | propagate.sh (멀티앱 전파) | **미구현** (§8 참조) |
...
## 9. Level 2 확장 설계 — Propagation Pipeline
...
### 8.3 change-spec.json (APK Lab과 동일 스키마)
...
## 11. Implementation Roadmap (3-Phase)
...
## 12. Matrix Architecture — ERP × FAB
...
> **"코드를 짜는 게 아니라 도구를 만들고 있다.**
> **다만 그 도구가 브라우저에서 돌아가고, 빌드 없이 배포되고, 구독 없이 쓸 수 있을 뿐이다."**
